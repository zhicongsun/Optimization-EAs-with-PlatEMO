...
%--------------------------------------------------------------------------
    ...
    ExternalPopulation = Global.Initialization(1);
    %% Optimization
    while Global.NotTermination(Population)
        MatingPool = TournamentSelection(2,Global.N,Fitness);
        Offspring  = GA(Population(MatingPool));
        [Population,Fitness,ExternalPopulation] = EnvironmentalSelection([Population,Offspring],ExternalPopulation,Global.N,0.25);
    end
end